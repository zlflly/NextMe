  ...
  return (
    <section>
      <section className="sm:px-28 sm:pt-12">
        ...
        {/* Tech stack sections with logos */}
        {/* Example:
        <div className={'flex w-full flex-col gap-6 rounded-lg bg-neutral-100 p-6 dark:bg-neutral-800'}>
          <section className={'flex items-center justify-between'}>
            <div className={'font-md text-neutral-600 dark:text-neutral-400'}>Frontend</div>
            <div className={'text-md flex items-center'}>
              <img alt="Next.js logomark" src="/next-logo.svg" className="!mr-1" width="20" height="20" />
              Next.js
            </div>
          </section>
        </div>
      ...
      {/* Image sections with blur placeholder animation */}
      {/* Example:
      <Image
        placeholder="blur"
        className={'mt-10'}
